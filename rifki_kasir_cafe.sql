...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 25 Mar 2022 pada 08.22
...
--
ALTER TABLE `rifki_detail_transaksi`
  MODIFY `rifki_id_detail_trans` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=74;

--
-- AUTO_INCREMENT untuk tabel `rifki_kategori`
--
ALTER TABLE `rifki_kategori`
  MODIFY `rifki_id_kategori` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT untuk tabel `rifki_log_pegawai`
--
ALTER TABLE `rifki_log_pegawai`
  MODIFY `rifki_id_log` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=178;
