...
<body style="background: black;">
	...
	<div style="margin-left: 20px;">
        		<a href="rifki_log_karyawan.php" class="btn btn-danger missing"  style="text-decoration:none; font-weight: bold;"  >Kembali</a>
	  	  </div>
	<?php  
	 session_start();
	 ...
	 ?>
        <div style="margin-left: 9%;">
        	<a href="rifki_log_cetak_karyawan.php" onclick="window.print();" style="text-decoration:none; font-weight: bold;" class="btn btn-warning missing">Cetak</a>
        </div>
	 	<br>
