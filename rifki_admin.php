...
<body>
	<header>
		...
		<ul>
			...
			<li><a href="rifki_regis.php">Tambah Pengguna</a></li>
			<li><a href="rifki_data-user.php">Data Pengguna</a></li>
			<li class="dropdown"><a href="#">Role</a>
				<ul class="isi-dropdown">
					<li><a href="rifki_tambah-role.php">Isi Role</a></li>
					<li><a href="rifki_data-role.php">Lihat Data Role</a></li>
				</ul>
			<li><a href="rifki_log_pegawai.php">Log Aktivitas</a></li>
