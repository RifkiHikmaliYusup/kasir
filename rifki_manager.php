		...
		<a href="#" class="logo">Cafe</a>
			<ul style="font-weight: bold;">
				...
				<ul class="isi-dropdown">
					<li><a href="rifki_tambah-makanan.php">Isi Menu</a></li>
					<li><a href="rifki_data-makanan.php">Data Menu</a></li>
				</ul>
				<li class="dropdown"><a href="#">Kategori</a>
				<ul class="isi-dropdown">
					<li><a href="rifki_tambah-kategori.php">Isi Kategori</a></li>
					<li><a href="rifki_data-kategori.php">Data Kategori</a></li>
				</ul>
				<li><a href="rifki_laporan-transaksi-manager.php">Laporan Transaksi</a></li>
				<li><a href="rifki_pendapatan.php">Pendapatan</a></li>
				<li><a href="rifki_log_karyawan.php">Log Pegawai</a></li>
